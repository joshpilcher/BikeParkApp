-- Dashboard counts for the live event session (still parked vs riders checked in)
-- Note: checked_in counts visits (see 20260503180000); still_parked counts devices.
...
comment on function public.event_session_stats(uuid) is
  'still_parked: devices on active visits; checked_in_total: active visits (excludes completed pickup).';
